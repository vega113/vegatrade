...
%garchfit. 
[coeff,errors,LLF,eFit,sFit] = garchfit(spec,prices);
...
[sigmaForecast,meanForecast,sigmaTotal,meanRMSE] = ...
      garchpred(coeff,prices,horizon);
...
%Compare the second garchpred output, meanForecast(the MMSE forecasts of
